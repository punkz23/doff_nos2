...
<h4 class="header blue">Terms and Condition</h4>
<form id="form">
@csrf
<div class="form-group">
    <label class="col-sm-3 control-label no-padding-right" for="form-field-pass1">Type</label>

    <div class="col-sm-9">
        <select name="type" class="form-control">
            <option value="none" disabled selected>--SELECT TYPE--</option>
            <option value="online-booking">ONLINE BOOKING (REGULAR)</option>
            <option value="pasabox">ONLINE BOOKING (PASABOX)</option>
...
<script type="text/javascript">
    jQuery(function($){
        ...
        $('select[name="type"]').on('change',function(){
            ...
            $.ajax({
                url : "{{url('/terms')}}/"+$(this).val(),
                type : "GET",
                dataType: "JSON",
                success: function(result){
                    var obj = result;
                    $('.note-editable').append(obj['content']);
                }
            });
        });
        ...
        $('#form').validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        form_data.append('body',$('.note-editable').html());
                        $.ajax({
                            url: "{{route('terms.maintenance_post')}}",
                            type: "POST",
                            data: form_data,
                            dataType: 'JSON',
                            processData: false,
