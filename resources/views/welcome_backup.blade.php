...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h1>The fastest way</h1>
      <h2>The Daily Overland way</h2>

          <!-- <a href="{{route('waybills.create_as_guest')}}" class="btn-get-started">Book now as Guest</a> -->
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box" style="height:390px;">
              <div class="icon"><a><i class="fa fa-truck"></i></a></div>
              <h4 class="title"><a>Trucking</a></h4>
          ...
          <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.4s">
            <div class="box" style="height:390px;">
              <div class="icon"><button type="button" class="btn btn-link" onclick="showMenu()"><i class="fa fa-desktop"></i></button></div>
              <h4 class="title"><a onclick="showMenu()">Online Booking</a></h4>
          ...
          <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.4s">
            <div class="box" style="height:390px;">
              <div class="icon"><a><i class="fa fa-road"></i></a></div>
          ...
          <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.6s">
            <div class="box" style="height:390px;">
              <div class="icon"><a><i class="fa fa-road"></i></a></div>
              <h4 class="title"><a>Deliver</a></h4>
      ...
      <div class="container">
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            ...
            <p>Yes, the Daily Overland Freight Forwarder provides services not only just for high value products but also for high value promises.</p>
      ...
      <div class="container wow fadeInUp">
          ...
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter="
                  ...
                  .filter-{{strtolower($row->name)}} {{$key<(count($branch_filters)-1) ? ',' : ''}}
                  @endforeach
        ...
        <div class="row" id="portfolio-wrapper">
          ...
          @foreach($branches as $key=>$row)
            ...
            <div class="col-lg-3 col-md-6 portfolio-item filter-{{strtolower($row->branch_filter->name)}}">
              ...
              <div class="details">
                  <h4>{{ucfirst($row->name)}} <small>{{$row->branch_contact->count()>0 ? '(' : ''}} @foreach($row->branch_contact as $k=>$c) {{$k>0 ? '/' : ''}}{{$c->contact_no}} @endforeach {{$row->branch_contact->count()>0 ? ')' : ''}}</small></h4>
                  @foreach($row->branch_schedule as $r)
                  <span>
    ...
    <section id="contact">
     ...
     <!--   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3872.9295565889247!2d121.61027671440773!3d13.939523783126763!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd4b5921782b6d%3A0x93acfd563e33559f!2s70+Osme%C3%B1a+Street%2C+Lucena%2C+Quezon%2C+Philippines!5e0!3m2!1sen!2s!4v1453874820081" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe> -->
      ...
      <div class="container wow fadeInUp mt-5">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              ...
              <div>
                ...
                <p>doff.it.department@gmail.com</p>
              </div>
              ...
              <div>
                ...
                <p><a href="{{route('request.qoutation')}}"> Request Qoutation</a> </p>
              </div>
            </div>
          ...
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link active" data-toggle="tab" href="#complain">Compain</a>
            </li>
            <li class="nav-item">
          ...
          <div class="tab-content">
            <div class="tab-pane container active" id="complain">
              ...
              <form id="form-complain" role="form" class="php-email-form-custom">
                @csrf
                  ...
                  <div class="form-group">
                    <input type="text" name="mname" class="form-control" id="mname" placeholder="Middle Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required/>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control" name="contact_no" id="contact_no" placeholder="Contact #" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required/>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" name="incident_subject" rows="5" data-rule="required" data-msg="Please write elaborate for us" placeholder="Complain Here" required></textarea>
                    <div class="validate"></div>
                  </div>
            ...
            <div class="tab-pane container fade" id="tech-support">
              <div class="form-support">
                <form id="form-support" role="form" class="php-email-form-custom">
                @csrf
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" name="description" rows="5" data-rule="required" data-msg="Please write elaborate for us" placeholder="Description"></textarea>
                    <div class="validate"></div>
                  </div>

                  <div class="text-center"><button class="btn btn-success" type="submit">Start Tech Support</button></div>
                </form>
              </div>
            </div>
          </div>
  ...
  <script src="{{asset('/js/laravel-encrypt.js')}}"></script>
  ...
  <script type="text/javascript">
    ...
    // console.log(window.crypto.subtle.__proto__.encrypt('Hello'));
    // eyJpdiI6InJOWmdHWkw3aGlqTmxjbnB3TjMwd3c9PSIsInZhbHVlIjoiZ1pla28xc0Nrcnh0MmdRM2E4MUZkMjd3cXlXWTBUdk9LVUtNekMyeHhidz0iLCJtYWMiOiI1MTFjMWEyZjcxN2RlNWMwOGQxZjY5OTI0MDUwZDY0N2NhMjAyMWE3NWE1ZjYwMjZiNmZiMDBjNWI4NDYyNTEzIn0=
    // console.log(decrypt('eyJpdiI6InJOWmdHWkw3aGlqTmxjbnB3TjMwd3c9PSIsInZhbHVlIjoiZ1pla28xc0Nrcnh0MmdRM2E4MUZkMjd3cXlXWTBUdk9LVUtNekMyeHhidz0iLCJtYWMiOiI1MTFjMWEyZjcxN2RlNWMwOGQxZjY5OTI0MDUwZDY0N2NhMjAyMWE3NWE1ZjYwMjZiNmZiMDBjNWI4NDYyNTEzIn0='));
    ...
    //   }
      ...
      $('#btnmessage').click(function(){
        $.ajax({
          url: "{{url('/chats/create')}}/{{Request::ip()}}",
          type: "GET",
          success: function(data){
            $('#btnmessage').attr('style','display:none;');
            $('#messages').html(data);
            scrollToBottomFunc();
          }
        })
