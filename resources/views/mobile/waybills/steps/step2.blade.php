<div class="block">
    <h2 class="block-title-medium">Shipper Info</h2>
            ...
            <ul>
                <li>
                    <div class="item-input-wrap">
                        <label class="toggle toggle-init color-blue">
                            <input type="checkbox" class="use-company" name="use_company_shipper">
                ...
                <li>
                    <div class="item-input-wrap">
                        <a class="item-link smart-select smart-select-init" data-open-in="popup"  data-searchbar="true" data-searchbar-placeholder="Search city" data-virtual-list="true">   
                            <select name="city" class="cities" id="shipper_city">
                ...
                <li class="item-content item-input item-input-with-info">
                    <div class="item-inner">
                        ...
                        <div class="item-input-wrap">
                            <input type="hidden" name="shipper_province" value="">
                ...
                <li class="item-content item-input item-input-with-info">
                    <div class="item-inner">
                        ...
                        <div class="item-input-wrap">
                            <input type="hidden" name="shipper_postal_code" value="">
