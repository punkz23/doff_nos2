...
<div class="page-header">
    <div class="row">
        <h1>
        <a href="{{url('/')}}"><i class="ace-icon fa fa-backward"></i></a>
            &nbsp;&nbsp;
            REQUEST FOR QOUTATION <small>Fields with <font color="red">(*)</font> are required</small>
        </h1>
...
<form id="form">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="contact_no" class="form-control" placeholder="Contact #"> 
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5">
            <div class="form-group">
                <select name="city_delivery" class="form-control" disabled>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5">
            <div class="form-group">
                <select name="city_pickup" class="form-control" disabled>
                    <option value="none" selected disabled>--Please select province, city and postal code--</option>
                    @foreach($provinces as $province)
                        <optgroup label="{{$province->province_name}}">
                            @foreach($province->city as $city)
        ...
        <div class="col-12">
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title">Shipments</h4>
                    <span class="widget-toolbar">
                        <button type="button" class="btn btn-primary btn-link add-item">
    ...
    <div class="row">
        <div class="clearfix pull-right">
            <button type="submit" class="btn btn-success submit">Send Request</button>
...
<script src="{{asset('/datatable/jquery-1.12.0.min.js')}}"></script>
    ...
    $(document).ready(function(){
        ...
        $('.chk-address').change(function(){
            ...
            if($(this).is(':checked')==true){
                ...
                $('input[name="barangay_'+type+'"]').closest('.form-group').removeClass('has-error');
                $('input[name="barangay_'+type+'"]').closest('.form-group').next().remove();
        ...
        $('.add-item').on('click',function(){
            ...
            if(validated==1){
                ...
                table.row.add([
                    '<div class="row"><div class="col-12"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="form-group"><select name="item_code[]" class="form-control description select2">'+"{!! $ddStocks !!}"+'</select></div></div><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="form-group"><input type="text" name="item_name[]" class="form-control item-name"></div></div></div></div>',
                    '<div class="row"><div class="form-group"><select name="unit_code[]" class="form-control unit select2">'+"{!! $ddUnits !!}"+'</select></div></div>',
                    '<div class="row"><div class="form-group"><input type="number" class="form-control quantity" name="quantity[]" disabled></div></div>',
                    '<div class="row"><button type="button" class="btn btn-sm btn-primary add-dimension"><i class="ace-icon fa fa-plus"></i></button>'+delete_btn+'</div>'
                ]).draw(false);
