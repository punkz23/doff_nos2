<form class="form-horizontal" id="form-step-3">
<div class="col-xs-12">
    ...
    <div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<select name="business_category_id" class="form-control select2" data-placeholder="Click to Choose...">
    ...
    <div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<select name="city" id="consignee_city" class="form-control select2 cities" data-placeholder="Click to Choose...">
				<option value="">&nbsp;</option>
    ...
    <div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
			<input type="hidden" name="consignee_province">
    ...
    <div class="form-group">
		...
		<div class="col-xs-12 col-sm-9">
		<input type="hidden" name="consignee_postal_code">
