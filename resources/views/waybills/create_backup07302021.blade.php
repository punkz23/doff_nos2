...
<script>
    $(document).ready(function(){
        ...
        $('.contacts').on('change',function(e){
            ...
            // if(elementName=='shipper'){
            //     $("#shipper_address_id").trigger('change'); 
            // }else{
            //     $("#consignee_address_id").trigger('change'); 
            // }
        ...
        // $('#form-step-4 input[name="reference_no"]').val("{{generateReferenceNumber()}}");
