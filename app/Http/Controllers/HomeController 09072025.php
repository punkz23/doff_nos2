...
class HomeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('auth')->except(['welcome','privacy_policy','terms_and_condition','faq','track_and_trace','getCities','previous','branch_details','track','claim','auth_check','landing_page','terms_and_condition','branch_serviceable_map','sector_list','get_sector_schedule','get_sector_province','get_sector_city','get_sector_brgy','get_sector_details','get_address_details','validate_email','get_id_type','get_qr_code_profile','profile_qr_code','get_customer_details']);
        View::share([
        'branches'=>Branch::get(),
